...
class __TwigTemplate_25008ae051985ac83de07b03ee7857adb8fcbfc1614d8cf85bca4751e9d2c10b extends Twig_Template
{
...
";
        ...
        try {
            ...
            if ((isset($context["items"]) ? $context["items"] : null)) {
                ...
                if (((isset($context["menu_level"]) ? $context["menu_level"] : null) == 0)) {
                    // line 30
                    echo "      <ul";
                    echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute((isset($context["attributes"]) ? $context["attributes"] : null), "addClass", array(0 => "menu", 1 => "nav", 2 => "navbar-nav", 3 => "secondary"), "method"), "html", null, true));
                    echo ">
    ";
                } else {
                    // line 32
    ...
    ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 35
                    echo "      ";
                    if ($this->getAttribute($this->getAttribute($context["item"], "attributes", array()), "hasClass", array(0 => "expanded"), "method")) {
                        // line 36
                        echo "        <li";
...
/*   {% if items %}*/
/*     {% if menu_level == 0 %}*/
/*       <ul{{ attributes.addClass('menu', 'nav', 'navbar-nav', 'secondary') }}>*/
/*     {% else %}*/
